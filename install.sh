...
# you can untar https://github.com/Clover-You/brew/tarball/master
# anywhere you like.
...
REQUIRED_RUBY_VERSION=2.6    # https://github.com/Clover-You/brew/pull/6556
...
# https://github.com/Clover-You/brew/blob/master/Library/Homebrew/keg.rb
directories=(
...
echo "$(
  cat <<EOS
  ${tty_underline}https://github.com/Clover-You/brew#donations${tty_reset}
EOS
)
"
